...
아래 빌드 방법으로 만든 `dist/Baram.app`을 더블클릭하세요. 메뉴 막대에 말풍선 번역 아이콘이 생깁니다. 자주 사용한다면 Finder에서 앱을 응용 프로그램 폴더로 옮겨 두면 됩니다.
...
4. 번역이 완료되면 결과 전체가 자동으로 선택됩니다. **⌘C**를 누르면 바로 서식 없이 복사됩니다.
